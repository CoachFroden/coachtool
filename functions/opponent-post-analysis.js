...
1. Finn riktig offentlig kampside via FIKS-ID og bruk den endelige offentlige kamprapporten hvis den er publisert.
2. Kontroller registrert kamptropp, målscorere, draktnumre og andre relevante registreringer etter kampen.
...
5. For hver spiller i den endelige offentlige kamptroppen: undersøk offentlig kamphistorikk på relevante lag. Prioriter de siste obligatoriske kampene før den aktuelle kampen.
...
8. Kontroller draktnumre og marker duplikater eller andre tydelige registreringsavvik.
...
10. Skille tydelig mellom dokumenterte fakta, regelvurdering og usikkerhet.
...
exports.analyzeOpponentPostMatch = onCall({
  ...
  const storedAnalysis = {
    ...
    sourcePolicy: "public-fotball-no"
  };
